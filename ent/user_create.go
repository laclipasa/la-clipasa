...
func (uc *UserCreate) SetTwitchID(s string) *UserCreate {
	uc.mutation.SetTwitchID(s)
	return uc
}
...
func (uc *UserCreate) AddSavedPostIDs(ids ...int) *UserCreate {
...
func (uc *UserCreate) check() error {
	...
	if _, ok := uc.mutation.TwitchID(); !ok {
		return &ValidationError{Name: "twitch_id", err: errors.New(`ent: missing required field "User.twitch_id"`)}
	}
	if _, ok := uc.mutation.Role(); !ok {
